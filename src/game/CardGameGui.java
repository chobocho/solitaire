...
public class CardGameGui extends JPanel implements GameObserver {
    ...
    public void paint(Graphics g) {
        ...
        commonDrawEngine.onDraw(graphicsBuffer, solitare, cardGameMouseAdapter.hideCard, cardImages, buttonImage);
        drawEngine.onDraw(graphicsBuffer, solitare, cardGameMouseAdapter.hideCard, cardImages, buttonImage);
